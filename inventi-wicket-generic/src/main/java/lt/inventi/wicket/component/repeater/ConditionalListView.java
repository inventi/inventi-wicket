...
/**
 * A {@link ListView} that returns <code>false</code> for {@link #isVisible} if
 * its list is empty. This allows you to use the
 * <code>&lt;wicket:enclosure&gt;</code> tag to hide surrounding markup.
 * Therefore you can use this component to ensure that, for example, the
 * <code>&lt;ul&gt;</code> is ommitted when you have zero
...
public abstract class ConditionalListView<T> extends ListView<T>
{
    ...
    public ConditionalListView(String id, IModel<? extends List<? extends T>> model) {
        super(id, model);
    }
